...
@Service
public class QueueMessageServiceSupportImpl implements QueueMessageServiceSupport {
	...
	public void send(Object message, ExchangeEnum exchangeEnum, QueueEnum queueEnum) throws Exception {
		...
		//System.out.println(exchangeEnum.getValue()+queueEnum.getRoutingKey()+message+correlationId);
